...
output_dict = {"cover": [], "supplier": [], "percentile_list": percentile_list}
...
with open(PROJECT_ROOT/"Experiments"/"output"/f"percentile_sensitivity_{m}_{k_facs}_narrow_robust.json", "w") as f:
