...
for seed in random_seeds:
    ...
    for k_facs in range(3, 11):
        radius_paths = stationary_supplier(potential_facilities, location_directory, pid_assignment, k_facs, upper_limit = 10)
    ...
    with open(PROJECT_ROOT/"Experiments"/"output"/"budget_sensitivity"/"supplier"/f"cville_budget_sensitivity_supplier_{seed}.json", "w") as f:
